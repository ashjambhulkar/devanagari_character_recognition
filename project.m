...
I = imread('C:\Users\Jeevy\Desktop\New folder\data_k.jpg');
Ib = im2bw(I);
Ib=~Ib;
a=0;
value=1;
...
for index=1:length(total_letters)
   ...
   if total_letters(index).Area > 500 && total_letters(index).BoundingBox(3)*total_letters(index).BoundingBox(4) < 60000
